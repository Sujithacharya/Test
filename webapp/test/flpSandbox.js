		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "mockserver",
									"targetURL": "#Mockservermockserver-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Mockservermockserver-display": {
								"semanticObject": "Mockservermockserver",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Mockserver.mockserver",
									"url": sap.ui.require.toUrl("Mockserver/mockserver")
								}
							}
						}
					}
